# Reachy Mini App Development Guide for AI Agents

> For agents helping users build apps **on top of** Reachy Mini. If you are working on the SDK itself (this repo), read [`../../AGENTS.md`](../../AGENTS.md) instead.
