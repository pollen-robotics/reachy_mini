...
The **Reachy Mini Lite** is the tethered version designed for education and development. It requires a computer to run its intelligence.
...
<div align="center">
  <a href="http://hf.co/reachy-mini/#/download">
    <img src="https://huggingface.co/spaces/pollen-robotics/Reachy_Mini/blob/main/public/assets/desktop-app-screenshot--white.png" width="600" alt="Reachy Mini Control App">
  </a>
</div>
