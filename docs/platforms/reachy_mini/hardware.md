...
- Dofs:
    ...
    ![Dofs](/docs/assets/degrees_of_freedom.png)
    
    ![dof_table](/docs/assets/dof_table.png)
...
![Mics_and_camera](/docs/assets/mic_and_camera.png)
...
- Motors specs
    ...
    ![Motors](/docs/assets/motors_detail.png)
...
- Power board
    ...
    ![Electronics](/docs/assets/electronics.png)
