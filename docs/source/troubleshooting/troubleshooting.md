...
If you have any of the following symptoms, please refer to the [Motors diagnosis and troubleshooting guide](./motors_diagnosis.md) for detailed steps to diagnose and fix motor-related issues.  
...
If your cable is plugged properly and you still have issues, it is likely that the FPC cable of the microphone is damaged. Please refer to the tutorial [How to change the FPC cable of the microphone of Reachy Mini?](./change_mic_fpc_cable.md) to fix this issue.
