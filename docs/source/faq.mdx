...
<details>
<summary><strong>How long does assembly usually take?</strong><br>Tags: <kbd>ASSEMBLY</kbd> <kbd>HARDWARE</kbd>
</summary>

Most testers report <b>1.5–2 hours</b>, with some up to <b>4 hours</b> depending on experience.


_Source: Hardware doc._

Tags: <kbd>ASSEMBLY</kbd> <kbd>HARDWARE</kbd>

</details><br>


<details>
<summary><strong>Are there any difficult steps during assembly?</strong><br>Tags: <kbd>ASSEMBLY</kbd> <kbd>HARDWARE</kbd>
</summary>
...
<details>
<summary><strong>How to Connect to a Wi-Fi network?</strong><br>Tags: <kbd>WiFi</kbd> <kbd>START</kbd> <kbd>WIRELESS</kbd>
</summary>
...
Tags: <kbd>WiFi</kbd> <kbd>START</kbd> <kbd>WIRELESS</kbd>

</details><br>


<details>
<summary><strong>Why do I need a virtual environment (.venv)?</strong><br>Tags: <kbd>SDK</kbd> <kbd>PYTHON</kbd> <kbd>ENVIRONMENT</kbd>
</summary>

Helps prevent package conflicts during SDK installation.


_Source: developers referencing `.venv` in troubleshooting threads._

Tags: <kbd>SDK</kbd> <kbd>PYTHON</kbd> <kbd>ENVIRONMENT</kbd>

</details><br>


<details>
<summary><strong>How to solve Chromadb / GStreamer / OpenCV installation issues?</strong><br>Tags: <kbd>AUDIO</kbd> <kbd>VISION</kbd> <kbd>DEPENDENCIES</kbd>
</summary>
...
Tags: <kbd>AUDIO</kbd> <kbd>VISION</kbd> <kbd>DEPENDENCIES</kbd>
...
<details>
<summary><strong>Is installing apps directly from the dashboard supported?</strong><br>Tags: <kbd>DASHBOARD</kbd> <kbd>APPS</kbd> <kbd>INSTALLATION</kbd>
</summary>
...
_Source: User guide._

Tags: <kbd>DASHBOARD</kbd> <kbd>APPS</kbd> <kbd>INSTALLATION</kbd>
...
<details>
<summary><strong>Is there a Scratch-like beginner mode?</strong><br>Tags: <kbd>TUTORIALS</kbd> <kbd>EDUCATION</kbd>
</summary>
...
Tags: <kbd>TUTORIALS</kbd> <kbd>EDUCATION</kbd>
...
<details>
<summary><strong>Installing an app from HuggingFace Space results in errors. What can I try?</strong><br>Tags: <kbd>INSTALLATION</kbd> <kbd>APPS</kbd> <kbd>SDK</kbd>
</summary>

Update the Reachy Mini SDK to the latest version. Earlier versions had a bug preventing smooth installation.


_Source: Community forum._

Tags: <kbd>INSTALLATION</kbd> <kbd>APPS</kbd> <kbd>SDK</kbd>

</details><br>


<details>
<summary><strong>Where can I see examples of apps?</strong><br>Tags: <kbd>APPS</kbd> <kbd>EXAMPLES</kbd>
</summary>
...
_Source: Hugging Face spaces._

Tags: <kbd>APPS</kbd> <kbd>EXAMPLES</kbd>
...
<details>
<summary><strong>How do I write a Reachy Mini app?</strong><br>Tags: <kbd>APPS</kbd> <kbd>SDK</kbd> <kbd>PROGRAMMING</kbd>
</summary>
...
_Source: API documentation._

Tags: <kbd>APPS</kbd> <kbd>SDK</kbd> <kbd>PROGRAMMING</kbd>

</details><br>


<details>
<summary><strong>How can I generate a new app template quickly?</strong><br>Tags: <kbd>APPS</kbd> <kbd>TOOLING</kbd>
</summary>
...
Tags: <kbd>APPS</kbd> <kbd>TOOLING</kbd>

</details><br>


<details>
<summary><strong>How do I add custom dance moves?</strong><br>Tags: <kbd>APPS</kbd> <kbd>MOVEMENT</kbd> <kbd>ANIMATION</kbd>
</summary>
...
Tags: <kbd>APPS</kbd> <kbd>MOVEMENT</kbd> <kbd>ANIMATION</kbd>

</details><br>


<details>
<summary><strong>Is it possible to make Reachy nod to music (tempo sync)?</strong><br>Tags: <kbd>AUDIO</kbd> <kbd>MOVEMENT</kbd> <kbd>AI</kbd>
</summary>
...
_Source: fallback authors (audio analysis discussion)._

Tags: <kbd>AUDIO</kbd> <kbd>MOVEMENT</kbd> <kbd>AI</kbd>

</details><br>


<details>
<summary><strong>Does the SDK support local AI actions (OpenAI-style)?</strong><br>Tags: <kbd>AI</kbd> <kbd>SDK</kbd> <kbd>APPS</kbd>
</summary>

Yes, users built local OpenAI-compatible integrations.


_Source: fallback community authors._

Tags: <kbd>AI</kbd> <kbd>SDK</kbd> <kbd>APPS</kbd>
...
<details>
<summary><strong>Is there a simulation environment?</strong><br>Tags: <kbd>SIMULATION</kbd> <kbd>SDK</kbd>
</summary>

Mentioned in discussions; models were being worked on but not yet official during beta.


_Source: Community discussion._

Tags: <kbd>SIMULATION</kbd> <kbd>SDK</kbd>
...
<details>
<summary><strong>How do I move Reachy Mini’s head to a specific pose?</strong><br>Tags: <kbd>MOVEMENT</kbd> <kbd>HEAD</kbd> <kbd>SDK</kbd>
</summary>
...
Tags: <kbd>MOVEMENT</kbd> <kbd>HEAD</kbd> <kbd>SDK</kbd>

</details><br>


<details>
<summary><strong>How do I control head orientation (roll, pitch, yaw)?</strong><br>Tags: <kbd>MOVEMENT</kbd> <kbd>HEAD</kbd>
</summary>
...
Tags: <kbd>MOVEMENT</kbd> <kbd>HEAD</kbd>

</details><br>


<details>
<summary><strong>How do I move head, body, and antennas at the same time?</strong><br>Tags: <kbd>MOVEMENT</kbd> <kbd>HEAD</kbd> <kbd>BODY</kbd> <kbd>ANTENNAS</kbd>
</summary>
...
Tags: <kbd>MOVEMENT</kbd> <kbd>HEAD</kbd> <kbd>BODY</kbd> <kbd>ANTENNAS</kbd>

</details><br>


<details>
<summary><strong>What’s the difference between `goto_target` and `set_target`?</strong><br>Tags: <kbd>MOVEMENT</kbd> <kbd>CONTROL</kbd> <kbd>CONTROL</kbd>
</summary>
...
Tags: <kbd>MOVEMENT</kbd> <kbd>CONTROL</kbd> <kbd>CONTROL</kbd>

</details><br>


<details>
<summary><strong>How do I choose the interpolation method for movements?</strong><br>Tags: <kbd>MOVEMENT</kbd> <kbd>INTERPOLATION</kbd>
</summary>
...
Tags: <kbd>MOVEMENT</kbd> <kbd>INTERPOLATION</kbd>

</details><br>


<details>
<summary><strong>How do I play predefined moves?</strong><br>Tags: <kbd>MOVEMENT</kbd> <kbd>DATASET</kbd> <kbd>PLAYBACK</kbd>
</summary>
...
Tags: <kbd>MOVEMENT</kbd> <kbd>DATASET</kbd> <kbd>PLAYBACK</kbd>

</details><br>


<details>
<summary><strong>How do I record my own moves for later replay?</strong><br>Tags: <kbd>MOVEMENT</kbd> <kbd>RECORDING</kbd> <kbd>TELEOP</kbd>
</summary>
...
Tags: <kbd>MOVEMENT</kbd> <kbd>RECORDING</kbd> <kbd>TELEOP</kbd>
...
<details>
<summary><strong>What are the safety limits of the head and body?</strong><br>Tags: <kbd>MOTORS</kbd> <kbd>LIMITS</kbd> <kbd>SAFETY</kbd>
</summary>
...
Tags: <kbd>MOTORS</kbd> <kbd>LIMITS</kbd> <kbd>SAFETY</kbd>

</details><br>


<details>
<summary><strong>What happens if I ask for a pose that exceeds limits?</strong><br>Tags: <kbd>MOTORS</kbd> <kbd>LIMITS</kbd>
</summary>
...
Tags: <kbd>MOTORS</kbd> <kbd>LIMITS</kbd>

</details><br>


<details>
<summary><strong>What are the specs of the power supply?</strong><br>Tags: <kbd>POWER</kbd> <kbd>HARDWARE</kbd>
</summary>

Users requested this information; no final spec was posted in chatlogs.


_Source: No direct data._

Tags: <kbd>POWER</kbd> <kbd>HARDWARE</kbd>

</details><br>


<details>
<summary><strong>How do I reset motors?</strong><br>Tags: <kbd>MOTORS</kbd> <kbd>RESET</kbd>
</summary>
...
Tags: <kbd>MOTORS</kbd> <kbd>RESET</kbd>

</details><br>


<details>
<summary><strong>How do I enable, disable, or make motors compliant?</strong><br>Tags: <kbd>MOTORS</kbd> <kbd>COMPLIANCY</kbd> <kbd>SAFETY</kbd>
</summary>
...
Tags: <kbd>MOTORS</kbd> <kbd>COMPLIANCY</kbd> <kbd>SAFETY</kbd>
...
<details>
<summary><strong>How do I access microphone audio samples?</strong><br>Tags: <kbd>AUDIO</kbd> <kbd>MEDIA</kbd>
</summary>
...
Tags: <kbd>AUDIO</kbd> <kbd>MEDIA</kbd>

</details><br>


<details>
<summary><strong>How do I send audio to the speaker?</strong><br>Tags: <kbd>AUDIO</kbd> <kbd>MEDIA</kbd>
</summary>
...
<details>
<summary><strong>Is camera quality good in various lighting conditions?</strong><br>Tags: <kbd>VISION</kbd> <kbd>CAMERA</kbd> <kbd>HARDWARE</kbd>
</summary>

Several testers reported excellent indoor performance, even in office lighting.


_Source: Users in chatlog, fallback authors._

Tags: <kbd>VISION</kbd> <kbd>CAMERA</kbd> <kbd>HARDWARE</kbd>

</details><br>


<details>
<summary><strong>How do I grab camera frames from Reachy Mini?</strong><br>Tags: <kbd>VISION</kbd> <kbd>CAMERA</kbd> <kbd>MEDIA</kbd>
</summary>
...
Tags: <kbd>VISION</kbd> <kbd>CAMERA</kbd> <kbd>MEDIA</kbd>

</details><br>


<details>
<summary><strong>How can I use the GStreamer backend instead of default OpenCV/sounddevice?</strong><br>Tags: <kbd>AUDIO</kbd> <kbd>VIDEO</kbd> <kbd>GSTREAMER</kbd> <kbd>ADVANCED</kbd>
</summary>
...
Tags: <kbd>AUDIO</kbd> <kbd>VIDEO</kbd> <kbd>GSTREAMER</kbd> <kbd>ADVANCED</kbd>
...
<details>
<summary><strong>Are CAD files available to customize Reachy Mini?</strong><br>Tags: <kbd>CAD</kbd> <kbd>3D_PRINTING</kbd>
</summary>
...
Tags: <kbd>CAD</kbd> <kbd>3D_PRINTING</kbd>

</details><br>


<details>
<summary><strong>Can I modify the appearance (custom skins)?</strong><br>Tags: <kbd>CUSTOMIZATION</kbd> <kbd>SKINS</kbd>
</summary>

Community members shared custom builds, including a Star Wars astromech variant.


_Source: elgrorg (fallback)._

Tags: <kbd>CUSTOMIZATION</kbd> <kbd>SKINS</kbd>
...
<details>
<summary><strong>Can Reachy wake up or move autonomously based on audio?</strong><br>Tags: <kbd>AUDIO</kbd> <kbd>MOVEMENT</kbd> <kbd>AI</kbd>
</summary>

Yes, users implemented wake-up behaviors and audio-reactive motions in the Radio App.


_Source: Fallback users._
...
<details>
<summary><strong>Can Reachy follow faces?</strong><br>Tags: <kbd>VISION</kbd> <kbd>FACE_TRACKING</kbd>
</summary>

Yes, with GStreamer + OpenCV, users achieved real-time face detection successfully.


_Source: Fallback user who posted “Reachy seeing me for the first time ❤️”._

Tags: <kbd>VISION</kbd> <kbd>FACE_TRACKING</kbd>

</details><br>


<details>
<summary><strong>Can I create a personalized behavior model?</strong><br>Tags: <kbd>AI</kbd> <kbd>PERSONALIZATION</kbd>
</summary>

Some users suggested discriminator-based personalization (“Make Reachy yours”).


_Source: Fallback author._

Tags: <kbd>AI</kbd> <kbd>PERSONALIZATION</kbd>

</details><br>


<details>
<summary><strong>How can I make Reachy Mini look at a point in the image?</strong><br>Tags: <kbd>VISION</kbd> <kbd>LOOK_AT_IMAGE</kbd>
</summary>
...
Tags: <kbd>VISION</kbd> <kbd>LOOK_AT_IMAGE</kbd>

</details><br>


<details>
<summary><strong>How can I make Reachy Mini look at a 3D point in the world?</strong><br>Tags: <kbd>VISION</kbd> <kbd>LOOK_AT_WORLD</kbd>
</summary>
...
Tags: <kbd>VISION</kbd> <kbd>LOOK_AT_WORLD</kbd>
...
<details>
<summary><strong>Is there a recommended way to share apps with the community?</strong><br>Tags: <kbd>APPS</kbd> <kbd>COMMUNITY</kbd> <kbd>CONTRIBUTING</kbd>
</summary>
...
Tags: <kbd>APPS</kbd> <kbd>COMMUNITY</kbd> <kbd>CONTRIBUTING</kbd>

</details><br>


<details>
<summary><strong>How can I submit improvements to the SDK?</strong><br>Tags: <kbd>SDK</kbd> <kbd>CONTRIBUTING</kbd>
</summary>

Via pull requests on our [GitHub](https://github.com/pollen-robotics/reachy_mini/blob/develop/README.md).


_Source: Documentation guidelines._

Tags: <kbd>SDK</kbd> <kbd>CONTRIBUTING</kbd>

</details><br>


<details>
<summary><strong>How can I contribute to datasets of moves (dances/emotions)?</strong><br>Tags: <kbd>CODING DATASET</kbd> <kbd>CONTRIBUTING</kbd> <kbd>MOVEMENT</kbd>
</summary>
...
_Source: Code repository._

Tags: <kbd>CODING DATASET</kbd> <kbd>CONTRIBUTING</kbd> <kbd>MOVEMENT</kbd>
...
<details>
<summary><strong>I haven’t received my package. How can I check it?</strong><br>Tags: <kbd>DELIVERY</kbd> <kbd>SHIPPING</kbd> <kbd>POST_SALES</kbd>
</summary>
...
Tags: <kbd>DELIVERY</kbd> <kbd>SHIPPING</kbd> <kbd>POST_SALES</kbd>

</details><br>


<details>
<summary><strong>I received my package but its severely damage.</strong><br>Tags: <kbd>DELIVERY</kbd> <kbd>SHIPPING</kbd> <kbd>POST_SALES</kbd>
</summary>
...
<details>
<summary><strong>Can I have a refund (before the unit being shipped)?</strong><br>Tags: <kbd>REFUND</kbd> <kbd>POST_SALES</kbd>
</summary>
...
Tags: <kbd>REFUND</kbd> <kbd>POST_SALES</kbd>

</details><br>


<details>
<summary><strong>Can I have a refund (after the unit being shipped)?</strong><br>Tags: <kbd>REFUND</kbd> <kbd>POST_SALES</kbd>
</summary>
...
<details>
<summary><strong>Warranty: My unit is malfunctioning / broken part ?</strong><br>Tags: <kbd>WARRANTY</kbd> <kbd>POST_SALES</kbd>
</summary>
...
Tags: <kbd>WARRANTY</kbd> <kbd>POST_SALES</kbd>
