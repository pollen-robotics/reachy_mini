...
<iframe
  src="https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/pollen-robotics/reachy_mini/main/docs/source/API/openapi.json"
  style="width:100%; height:80vh; border:none;"
></iframe>

[Open in full page](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/pollen-robotics/reachy_mini/main/docs/source/API/openapi.json) · [Download OpenAPI spec (JSON)](https://raw.githubusercontent.com/pollen-robotics/reachy_mini/main/docs/source/API/openapi.json)

## More complex apps

See the [../SDK/javascript-sdk.md](../SDK/javascript-sdk.md) page for examples of more complex apps using the JavaScript SDK, which leverages the WebRTC transport and provides higher-level abstractions for video, audio, and robot control.