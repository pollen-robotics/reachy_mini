...
<!-- ### WiFi Configuration Router -->

 <!-- [[autodoc]] reachy_mini.daemon.app.routers.wifi_config.get_current_wifi_mode -->

<!-- [[autodoc]] reachy_mini.daemon.app.routers.wifi_config.get_wifi_status -->

<!-- [[autodoc]] reachy_mini.daemon.app.routers.wifi_config.get_last_wifi_error -->

<!-- [[autodoc]] reachy_mini.daemon.app.routers.wifi_config.reset_last_wifi_error -->

<!-- [[autodoc]] reachy_mini.daemon.app.routers.wifi_config.setup_hotspot -->

<!-- [[autodoc]] reachy_mini.daemon.app.routers.wifi_config.connect_to_wifi_network -->

<!-- [[autodoc]] reachy_mini.daemon.app.routers.wifi_config.scan_wifi -->

<!-- [[autodoc]] reachy_mini.daemon.app.routers.wifi_config.forget_wifi_network -->

<!-- [[autodoc]] reachy_mini.daemon.app.routers.wifi_config.forget_all_wifi_networks -->
