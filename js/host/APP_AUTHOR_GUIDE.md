...
export default defineConfig({
  ...
  optimizeDeps: {
    include: ['@pollen-robotics/reachy-mini-sdk/host', '@pollen-robotics/reachy-mini-sdk/host/auto',
              '@pollen-robotics/reachy-mini-sdk/host/embed'],
  },
});
```

Once `@pollen-robotics/reachy-mini-sdk/host` is published to npm proper, this `dedupe`
won't be needed.
