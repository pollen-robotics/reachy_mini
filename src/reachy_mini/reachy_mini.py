...
class ReachyMini:
    ...
    def look_at_image(self, u: int, v: int, duration: float = 1.0, perform_movement: bool = True) -> np.ndarray:
        ...
        return self.look_at_world(*P_world, duration=duration, perform_movement=perform_movement)

    def look_at_world(self, x: float, y: float, z: float, duration: float = 1.0, perform_movement: bool = True) -> np.ndarray:
