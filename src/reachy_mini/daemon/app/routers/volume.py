...
async def get_volume() -> VolumeResponse:
    ...
    return _read_volume(vc.get_output_volume, vc, vc.output_device_name, "Failed to get volume")
...
async def set_volume(
    ...
    vc = _get_volume_control()
    response = _write_volume(vc.set_output_volume, volume_req.volume, vc, vc.output_device_name, "Failed to set volume")
...
async def get_microphone_volume() -> VolumeResponse:
    ...
    vc = _get_volume_control()
    return _read_volume(vc.get_input_volume, vc, vc.input_device_name, "Failed to get microphone volume")
...
async def set_microphone_volume(volume_req: VolumeRequest) -> VolumeResponse:
    ...
    vc = _get_volume_control()
    return _write_volume(vc.set_input_volume, volume_req.volume, vc, vc.input_device_name, "Failed to set microphone volume")
