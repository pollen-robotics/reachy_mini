...
OAUTH_CLIENT_ID: Optional[str] = os.environ.get("HF_OAUTH_CLIENT_ID", _DEFAULT_OAUTH_CLIENT_ID)
OAUTH_CLIENT_SECRET: Optional[str] = os.environ.get("HF_OAUTH_CLIENT_SECRET")
OAUTH_SCOPES = os.environ.get("HF_OAUTH_SCOPES", "openid profile read-repos")
...
async def exchange_code_for_token(
    ...
    if not session:
        return {"status": "error", "message": "Invalid or expired session. Please try again."}
