...
> The latency compensation described in this step was an experiment on the development branch. It is not in the code base: `HeadWobbler` schedules each hop at its playout time.
