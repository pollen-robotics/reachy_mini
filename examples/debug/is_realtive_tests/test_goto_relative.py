    ...
    with ReachyMini() as mini:
        ...
        try:
            ...
            for i, (y, z) in enumerate(rectangle_points):
                corner_name = ["top-right", "bottom-right", "bottom-left", "top-left"][
                    i
                ]
                print(
                    f"Moving to {corner_name}: Y={y * 1000:.0f}mm, Z={z * 1000:.0f}mm"
                )
                ...
                mini.goto_target(
                    head=relative_pose, duration=2.0, method="minjerk", is_relative=True
                )
            ...
            print(
                "Rectangle motion should smoothly return to zero while pitch continues"
            )
